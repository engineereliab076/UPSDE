...
export function MobileMenu({ open, onClose }: MobileMenuProps) {
  ...
  return (
        <div className="fixed inset-0 z-50 xl:hidden" id="mobile-menu">
          <button
            type="button"
          ...
          <div
            ...
            className="absolute right-0 top-0 flex h-full w-[min(92vw,27rem)] flex-col overflow-y-auto bg-background shadow-2xl"
          >
            ...
            <div className="space-y-2.5 border-t border-line px-5 py-6 text-sm text-ink-secondary">
